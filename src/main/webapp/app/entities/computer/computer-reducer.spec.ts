...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './computer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPUTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPUTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPUTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPUTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPUTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPUTER actions', async () => {
      const expectedActions = [
        {
