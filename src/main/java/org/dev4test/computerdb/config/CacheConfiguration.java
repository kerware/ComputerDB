...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.dev4test.computerdb.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.dev4test.computerdb.repository.UserRepository.USERS_BY_EMAIL_CACHE);
